 ...
 *      </pre>
 */
public class JobFairCenterBean extends CommonBean {
	...
	private Integer bkmkCnt;
	private String bkmkSeq;
	private String fairWorkshopViewYn;
	...
	public String getFairDtlExplnNm() {
		return fairDtlExplnNm;
	}
	public void setFairDtlExplnNm(String fairDtlExplnNm) {
		this.fairDtlExplnNm = fairDtlExplnNm;
	}
	...
	public String getFairDivClass() {
		return fairDivClass;
	}
	public void setFairDivClass(String fairDivClass) {
		this.fairDivClass = fairDivClass;
	}
	...
	public Integer getBkmkCnt() {
		return bkmkCnt;
	}
	public void setBkmkCnt(Integer bkmkCnt) {
	...
	public String getFairWorkshopViewYn() {
		return fairWorkshopViewYn;
	}
	public void setFairWorkshopViewYn(String fairWorkshopViewYn) {
		this.fairWorkshopViewYn = fairWorkshopViewYn;
	}
	...
	public String getFairNoti() {
		return fairNoti;
	}
	public void setFairNoti(String fairNoti) {
		this.fairNoti = fairNoti;
	}
	...
	public Integer getBoothAvailableCnt() {
		return boothAvailableCnt;
	}
	public void setBoothAvailableCnt(Integer boothAvailableCnt) {
		this.boothAvailableCnt = boothAvailableCnt;
	}
