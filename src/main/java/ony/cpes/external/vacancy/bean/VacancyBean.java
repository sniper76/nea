...
public class VacancyBean extends CommonBean {
	...
	private String compnyIsicNm;
	private String compnyAddrDtl;
	...
	public String getCompnyIsicNm() {
		return compnyIsicNm;
	}

	public void setCompnyIsicNm(String compnyIsicNm) {
		this.compnyIsicNm = compnyIsicNm;
	}

	public String getCompnyAddrDtl() {
		return compnyAddrDtl;
	}

	public void setCompnyAddrDtl(String compnyAddrDtl) {
		this.compnyAddrDtl = compnyAddrDtl;
	}
