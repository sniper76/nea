package ony.cpes.external.stditSearch.controller;
...
@RequestMapping("/cpes/compny/stditSearch")
@Controller
public class StditSearchController extends BaseController{
	...
	@RequestMapping("/stditSearchForm")
	public ModelAndView hrSearchForm() {
		ModelAndView mv = new ModelAndView();

		mv.setViewName("stditSearch/stditSearch.one");
		return mv;
	}
	...
	public ModelAndView searchForm(@ModelAttribute("ConditionBean") ConditionBean conditionBean, @ModelAttribute("HrSearchBean") HrSearchBean hrSearchBean,
		...
		mv.setViewName("stditSearch/searchForm.empty");
		return mv;
	}

	@RequestMapping("/stditSearchResult")
	public ModelAndView hrSearchResult(@ModelAttribute("HrSearchBean") HrSearchBean hrSearchBean, Locale locale,
		...
		hrSearchBean.setFirstIndex(paginationInfo.getFirstRecordIndex());
	  	...
	  	hrSearchBean.setSearchType("stdit");
		...
		mv.setViewName("stditSearch/stditSearchResult.one");
		return mv;
	}
}
