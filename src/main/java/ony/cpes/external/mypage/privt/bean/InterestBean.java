...
public class InterestBean extends CommonBean{
	...
	private String neaEduDivNm;
	private String teachDt;
	private String teachBgnTime;
	...
	public String getNeaEduDivNm() {
		return neaEduDivNm;
	}
	public void setNeaEduDivNm(String neaEduDivNm) {
		this.neaEduDivNm = neaEduDivNm;
	}
	...
	public String getTeachBgnTime() {
		return teachBgnTime;
	}
	public void setTeachBgnTime(String teachBgnTime) {
		this.teachBgnTime = teachBgnTime;
	}
