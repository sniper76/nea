package ony.cpes.external.member.bean;
 ...
 * </pre>
 */
public class CompanyBean extends CommonBean{
	...
	private int disablEmployeeTotCnt;//장애인_종업원_합계_계산
	private int employeeTotCnt;//종업원_총수
	private int femaleEmployeeTotCnt;//여성_종업원_합계_계산
	private String fileGrpSeq;//파일_그룹_시퀀스
	private int forgnerTotCnt;//외국인_합계_계산
	...
	public int getDisablEmployeeTotCnt() {
		return disablEmployeeTotCnt;
	}
	public void setDisablEmployeeTotCnt(int disablEmployeeTotCnt) {
		this.disablEmployeeTotCnt = disablEmployeeTotCnt;
	}
	public int getEmployeeTotCnt() {
		return employeeTotCnt;
	}
	public void setEmployeeTotCnt(int employeeTotCnt) {
		this.employeeTotCnt = employeeTotCnt;
	}
	public int getFemaleEmployeeTotCnt() {
		return femaleEmployeeTotCnt;
	}
	public void setFemaleEmployeeTotCnt(int femaleEmployeeTotCnt) {
	...
	public int getForgnerTotCnt() {
		return forgnerTotCnt;
	}
	public void setForgnerTotCnt(int forgnerTotCnt) {
