	...
	<main class="colgroup" id="colgroup">
    	<article>
			<header class="sub_head">
				<div class="sub_title">
					<h2><span><spring:message code="vacancy.search.msg4"/></span></h2>
				</div>
           	</header>
           	 <div id="contents" class="vacancyInternDtlSearch">
				<div class="srch_box">
					<div class="top_area">
						<span class="cont_box">
					...
					<div class="srch_area advanced"><!-- 상세 검색 있을 때 클래스 advanced 추가 -->
						<div class="box_wrap">
							<form id="frmSearch" name="frmSearch" action="${pageContext.request.contextPath}/vacancy/internDtlSearch.do" method="post">
					...
					<div class="detail_area">
						<div class="box_wrap">
							<form id="frmDtlSearch" name="frmDtlSearch" action="${pageContext.request.contextPath}/vacancy/internDtlSearch.do" method="post">
