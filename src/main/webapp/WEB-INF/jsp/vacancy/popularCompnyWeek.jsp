			...
			<div class="sub_title">
				<div class="sub_tab_menu count3">
					<ul class="clearfix">
						<li>
							<!-- Popular Companies -->
							<a href="#tab_contents1" onclick="fnTabChange('TODAY');"><spring:message code="jobseeker.vacancy.popular.company.ttl01" /></a>
						</li>
						<li class="on">
							<!-- Company of the Week -->
							<a href="#tab_contents2" onclick="fnTabChange('WEEK');"><spring:message code="jobseeker.vacancy.popular.company.ttl05" /></a>
						</li>
						<li>
							<!-- Company of the Month -->
							<a href="#tab_contents3" onclick="fnTabChange('MONTH');"><spring:message code="jobseeker.vacancy.popular.company.ttl02" /></a>
						</li>
					</ul>
				</div>
				<!-- Popular Companies -->
				<h2><span><spring:message code="jobseeker.vacancy.popular.company.ttl05" /></span></h2>
			</div>
		</header>
		<div id="contents">
			<div class="srch_box">
...
<script>
   	...
   	function fnTabChange(flag) {
   		if(flag == "WEEK") {
			document.location.href = contextPath + "/vacancy/popularCompnyWeek.do";
   		} else if(flag == "MONTH") {
   	...
   	function fnSearch(pageNo) {
		...
		f.action = contextPath + "/vacancy/popularCompnyWeek.do";
