...
<%@ include file="/WEB-INF/jsp/common/inc.jsp" %>
    ...
    var pageSize = 10;
    	...
    	function fnSetAdvanceSrch() {
    		...
    		$('div.detail_area select#condKeyword').val('00');
    	...
    	function fnGoSrch(page, params) {
			...
			$.ajax({
				type: METHOD_POST,
				url: contextPath + "/eduTrnng/eduTrnngNeaListAjax.do",
			...
			$('ul.recruitment_list').empty();
       		...
       		for (var k=0; k<lst.length; k++) {
       			...
       			var html = '';
		        	...
		        	html += '		<div class="contents_box employement">                               ';
	...
	<main class="colgroup" id="colgroup">
            <article>
                <header class="sub_head">
                    ...
                    <div class="sub_title">
						<h2><span><spring:message code="eduTrnng.free.search.title8"/></span></h2>
					</div>
                </header>

                <div id="contents" class="eduTrnngEduTrnngNeaList">
					...
					<div class="srch_box">
						...
						<div class="detail_area">
							<div class="box_wrap">
					<form id="frm" name="frm" action="${pageContext.request.contextPath}/eduTrnng/neaView.do" method="post">
											...
											<tr>
												...
												<td colspan="3">
													...
													<select id="condKeyword" name="condKeyword">
														<option value="00"><spring:message code="counsel.msg.all"/></option>
