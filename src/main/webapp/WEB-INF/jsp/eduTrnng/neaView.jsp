	...
	<main class="colgroup" id="colgroup">
            <article>
                <header class="sub_head">
                    ...
                    <div class="sub_title">
						<h2><span><spring:message code="eduTrnng.free.search.title29"/></span></h2>
					</div>
                </header>

                <div id="contents" class="eduTrnngNeaView">
<form id="frm" name="frm" action="${pageContext.request.contextPath}/eduTrnng/neaApply.do" method="post">
