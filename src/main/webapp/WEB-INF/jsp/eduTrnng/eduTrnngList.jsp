...
<%@ include file="/WEB-INF/jsp/common/inc.jsp" %>
    <script>
    	$(document).ready(function() {
			...
			fnSetSelecteBox("condAreaCd","<c:out value="${param.condAreaCd}"/>");
    	});
	...
	<main class="colgroup" id="colgroup">
		<article>
	    	<header class="sub_head">
				<div class="sub_title">
					<h2>
						<span><spring:message code="mypage.instt.eduTrnng.title26"/> / <spring:message code="eduTrnng.msg"/></span>
					</h2>
				</div>
	      	</header>

	       	<div id="contents" class="eduTrnngEduTrnngList">
				<div class="bbs_info clearfix tab_confirm"><!-- 서브페이지에 탭 메뉴가 있을 경우 클래스 tab_confirm 추가  -->

					<form id="frm" name="frm" action="${pageContext.request.contextPath}/eduTrnng/eduTrnngList.do" method="post">
