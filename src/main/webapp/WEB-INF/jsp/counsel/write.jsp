...
<%@ include file="/WEB-INF/jsp/common/inc.jsp" %>
    <script>
				...
				success : function(json, statusText, xhr, $form) {
					if (json.result.successYn == "Y") {
						alertify.alert("<spring:message code="counsel.msg.reg.ok"/>", function (e){
							fnGoMoveUrl('frmSearch', '${pageContext.request.contextPath}/cpes/private/counsel/list.do');
						});
		...
		function fnCounselWriteDetail() {
			$.ajax({
				url: contextPath + "/cpes/private/counsel/writeDtailAjax.do",
				data: {
	    	...
	    	<header class="sub_head">
	       	...
	       	<div id="contents" class="counselWrite">
				...
				<div class="bbs_basic">
					...
					<form id="frm" name="frm" action="${pageContext.request.contextPath}/cpes/private/counsel/writeProcessAjax.do" method="post">
