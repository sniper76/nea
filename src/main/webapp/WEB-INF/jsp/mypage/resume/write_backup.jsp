    		...
    		$('#btn_save').on('click', function(){
				...
				$('.ref_form').each(function(){
					...
					if(ref_nm == "" || ref_orgnzNm == "" || ref_position == "" || ref_ref == "" || ref_cell == "" || ref_email == ""
						|| ref_addrNm == "" || ref_addrCd == "" || ref_addrDtl == ""){
					...
					<div class="form_box">
						<div class="form_element select have_child">
							...
							<div class="select_box">
								...
								<li>
									<span>
										<input type="radio" name="disablYn" class="have" id="radio01_1" />
										<label for="radio01_1">Yes</label>
									</span>
								</li>
								<li>
									<span>
										<input type="radio" name="disablYn" class="no_have" id="radio01_2" />
					...
					<div class="form_box count2">
						<div class="form_element select">
							...
							<div class="select_box">
								...
								<li>
									<span>
										<input type="radio" name="selfempYn" id="radio02_1" />
										<label for="radio02_1">Yes</label>
									</span>
								</li>
								<li>
									<span>
										<input type="radio" name="selfempYn" id="radio02_2" />
				...
				<div class="form_contents">
					...
					<div class="form_box">
						<div class="form_element pick">
							...
							<!-- <div class="popup_box" id="isco_popup">
								<div class="bbs_popup">
									<section class="box_wrap">
										<div class="title_box">
					...
					<div class="form_box count3">
						<div class="form_element input">
							<div class="view_area">
								...
								<input type="text" id="langUseCd" name="langUseCd" class="text_box" maxlength="10"/>
							</div>
						</div>
					</div>
					<!-- //form_box -->
