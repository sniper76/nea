...
<%@ include file="/WEB-INF/jsp/common/inc.jsp" %>
    ...
    var keywordList = [];
	    				...
	    				if($('#uploadImgFile').val() != ""){
	        				...
	        				$.ajax({
	        					...
	        					success: function(data) {
	        						imgFileSeq = data.result;

	        						$.ajax({
	        	    					type: 'post',
	        	    					url: contextPath + "/cpes/private/resume/insertResumeAjax.do",
	        	    					dataType: 'json',
	        	    					data: {
    	...
    	/* function fnRefAddrSet(json, e){
    		var addrHtml = "<span>" + json.commonNm + "<input type='hidden' name='ref_addrCd' value='" + json.commonCd + "'/>";
    		addrHtml += "<input type='hidden' name='ref_addrFullNm' value='" + json.commonFullNm + "'/>";
    		addrHtml += "<input type='hidden' name='ref_addrFullCd' value='" + json.commonFullCd + "'/>";
    		addrHtml += "<button type='button'>delete</button></span>";

			$(e.target).closest('.form_element').find('.text_box').append(addrHtml);
			$(e.target).closest('.form_element').addClass('active');
			fnScriptReset();
    	} */
...
<main class="colgroup" id="colgroup">
	<article>
		<header class="sub_head">
			<div class="sub_title">
				<h2><span><spring:message code="resume.text.resumeInsert"/></span></h2>
			</div>
		</header>

		<div id="contents" class="resumeWite">
			<div class="profile_title">
				<label for="profile_title">Please input your CV Title</label>
				<input type="text" id="profile_title" name="resumeTitle" maxlength="500"/>
			</div>

			<div class="profile_box">
				<div class="img_box"><!-- 등록된 사진이 있는 경우 주석 사용 -->
					<%-- <c:choose>
						<c:when test="${not empty memberImg }">
							<button id="btn_imgAdd" type="button" class="photo add_photo btn_fileSelect" style="display: none;">Add Photo</button>
							<img id="uploadImg" src="/common/imgLoading.do?url=${memberImg.saveFilePath}" alt="" class="photo" />
				...
				<div class="form_contents">
					<div class="form_box">
						<div class="form_element pick" id="addr">
							<div class="view_area">
								<span class="label">
									<spring:message code="resume.text.placeOfBirth"/>
								</span>
						...
						<div class="form_element select">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="marriCd_focus">
									<span>Open</span>
									<input type="hidden" id="marriCd" name="marriCd" value="">
								</button>
							</div>
					...
					<div class="form_box count3">
						<div class="form_element input">
							<div class="view_area">
								...
								<input type="text" id="familyCnt" class="text_box inputNo" name="familyCnt"/>
							</div>
						</div>
						<div class="form_element input">
							<div class="view_area">
								<label for="" class="label"><spring:message code="resume.text.insertUnderAge15"/></label>
								<input type="text" id="underAge15FamilyCnt" class="text_box inputNo" name="underAge15FamilyCnt"/>
							</div>
						</div>
						<div class="form_element input">
							<div class="view_area">
								<label for="" class="label"><spring:message code="resume.text.insertOverAge65"/></label>
								<input type="text" id="overAge64FamilyCnt" class="text_box inputNo" name="overAge64FamilyCnt"/>
							</div>
						</div>
					</div>
				<!-- //form_box -->
					...
					<div class="form_box">
						<div class="form_element select have_child">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="disablYn_focus"><span>Open</span></button>
							</div>
							<div class="select_box">
								<ul class="clearfix">
								<li>
									<span>
										<input type="radio" name="disablYn" class="have" id="radio01_1" value="Y"/>
										<label for="radio01_1">Yes</label>
									</span>
								</li>
								<li>
									<span>
										<input type="radio" name="disablYn" class="no_have" id="radio01_2" value="N"/>
					...
					<div class="form_box count2">
						<div class="form_element select">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="selfempYn_focus"><span>Open</span></button>
							</div>
							<div class="select_box">
								<ul class="clearfix">
								<li>
									<span>
										<input type="radio" name="selfempYn" id="radio02_1" value="Y"/>
										<label for="radio02_1">Yes</label>
									</span>
								</li>
								<li>
									<span>
										<input type="radio" name="selfempYn" id="radio02_2" value="N"/>
					...
					<%-- <div class="form_box count2">
						<div class="form_element select">
							...
							<div class="select_box">
								...
								<li>
									<span>
										<input type="radio" name="urgentJobseekYn" id="radio03_1" />
										<label for="radio03_1">Yes</label>
									</span>
								</li>
								<li>
									<span>
										<input type="radio" name="urgentJobseekYn" id="radio03_2" />
					...
					<div class="form_box count3">
						<div class="form_element input">
							<div class="view_area">
								...
								<input type="text" id="preferJobTitle" name="preferJobTitle" class="text_box" maxlength="150"/>
							</div>
						</div>
						<div class="form_element input">
							<div class="view_area">
								<label for="" class="label"><spring:message code="resume.text.preferPosition"/></label>
								<input type="text" id="preferPosition" name="preferPosition" class="text_box" maxlength="50"/>
							</div>
						</div>
					</div>
					<!-- //form_box -->
						...
						<div class="form_element select">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="employFormCd_focus">
									<span>Open</span>
									<input type="hidden" id="employFormCd" name="employFormCd" value="">
								</button>
							</div>
							<div class="select_box">
								<ul class="clearfix">
					...
					<div class="form_box">
						<div class="form_element select have_child">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="preferEmployTypeCd_focus"><span>Open</span></button>
							</div>
							<div class="select_box">
								<ul class="clearfix">
											...
											<span>
												...
												<c:choose>
													<c:when test="${preferEmploymtTypeCd.dtlCd eq 'PET0000000001'}">
														<input type="radio" name="preferEmployTypeCd" class="no_have" id="preferEmploymtTypeCd${preferEmploymtTypeCd.dtlCd}" value="${preferEmploymtTypeCd.dtlCd }"/>
													</c:when>
													<c:otherwise>
														<input type="radio" name="preferEmployTypeCd" class="have" id="preferEmploymtTypeCd${preferEmploymtTypeCd.dtlCd}" value="${preferEmploymtTypeCd.dtlCd }"/>
													</c:otherwise>
												</c:choose>
						...
						<div class="child_form">
							<div class="form_element input count3">
								<div class="view_area">
									...
									<input type="text" id="typeEmployHourDay" name="typeEmployHourDay" class="text_box inputTime" maxlength="2"/>
								</div>
							</div>
							<div class="form_element input count3">
								<div class="view_area">
									<label for="" class="label"><spring:message code="resume.text.typeEmployDayWeek"/></label>
									<input type="text" id="typeEmployDayWeek" name="typeEmployDayWeek" class="text_box inputWeek" maxlength="1"/>
								</div>
							</div>
							<div class="form_element check">
								<div class="view_area">
								...
								<div class="check_box">
									...
									<li>
										<span>
											<input type="checkbox" id="preferDayMon" name="preferDayMon" value="Y"/>
											<label for="preferDayMon">Monday</label>
										</span>
									</li>
									<li>
										<span>
											<input type="checkbox" id="preferDayTue" name="preferDayTue" value="Y"/>
											<label for="preferDayTue">Tuesday</label>
										</span>
									</li>
									<li>
										<span>
											<input type="checkbox" id="preferDayWed" name="preferDayWed" value="Y" />
											<label for="preferDayWed">Wednesday</label>
										</span>
									</li>
									<li>
										<span>
											<input type="checkbox" id="preferDayThu" name="preferDayThu" value="Y"/>
											<label for="preferDayThu">Thursday</label>
										</span>
									</li>
									<li>
										<span>
											<input type="checkbox" id="preferDayFri" name="preferDayFri" value="Y" />
											<label for="preferDayFri">Friday</label>
										</span>
									</li>
									<li>
										<span>
											<input type="checkbox" id="preferDaySat" name="preferDaySat" value="Y"/>
											<label for="preferDaySat">Saturday</label>
										</span>
									</li>
									<li>
										<span>
											<input type="checkbox" id="preferDaySun" name="preferDaySun" value="Y"/>
					...
					<div class="form_box count3">
						<div class="form_element select have_child">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="preferCrtctType_focus"><span>Open</span></button>
							</div>
							<div class="select_box">
								<ul class="clearfix">
									<c:forEach items="${termOfEmploymentContractList }" var="termOfEmploymentContract">
										<li>
											<span>
												<input type="radio" name="preferCrtctType" id="termOfEmploymentContract${termOfEmploymentContract.dtlCd}" value="${termOfEmploymentContract.dtlCd}"/>
					...
					<div class="form_box">
						<div class="form_element check">
							...
							<div class="check_box">
								...
								<li>
									<span>
										<input type="checkbox" id="nightWorkYn" name="nightWorkYn" value="Y"/>
										<label for="nightWorkYn">Night shift(pm 10:00~am 05:00)</label>
									</span>
								</li>
								<li>
									<span>
										<input type="checkbox" id="overTimeWorkYn" name="overTimeWorkYn" value="Y"/>
										<label for="overTimeWorkYn">Overtime</label>
									</span>
								</li>
								<li>
									<span>
										<input type="checkbox" id="hldayWorkYn" name="hldayWorkYn" value="Y"/>
					...
					<div class="form_box count3_half">
						<div class="form_element input">
							<div class="view_area">
								...
								<input type="text" id="expctMinSalaryAmt" name="expctMinSalaryAmt inputNo" class="text_box" />
							</div>
						</div>
						...
						<div class="form_element input">
							<div class="view_area">
								<label for="" class="label"><spring:message code="resume.text.expctSalaryAmt"/></label>
								<input type="text" id="expctMaxSalaryAmt" name="expctMaxSalaryAmt inputNo" class="text_box" />
							</div>
						</div>
					</div>
			<!-- //form_box -->
					...
					<div class="form_box count3">
						<div class="form_element select have_child">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="diffProvcWorkYn_focus"><span>Open</span></button>
							</div>
							<div class="select_box">
								<ul class="clearfix">
								<li>
									<span>
										<input type="radio" name="diffProvcWorkYn" id="radio06_1" value="Y"/>
										<label for="radio06_1">Yes</label>
									</span>
								</li>
								<li>
									<span>
										<input type="radio" name="diffProvcWorkYn" id="radio06_2" value="N"/>
					...
					<div class="form_box count3">
						<div class="form_element select">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="workBgnAbleYn_focus"><span>Open</span></button>
							</div>
							<div class="select_box">
								<ul class="clearfix">
								<li>
									<span>
										<input type="radio" name="workBgnAbleYn" id="radio07_1" value="Y"/>
										<label for="radio07_1"><spring:message code="resume.text.workBgnAbleY"/></label>
									</span>
								</li>
								<li>
									<span>
										<input type="radio" name="workBgnAbleYn" class="ohter" id="radio07_2" value="N"/>
						...
						<div class="form_element input other_child">
							<div class="view_area">
								...
								<input type="text" id="workBgnAbleWithin" name="workBgnAbleWithin" class="text_box inputNo" />
							</div>
						</div>
					</div>
			<!-- //form_box -->
						...
						<div class="form_element select">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="eduDegreeCd_focus">
									<span>Open</span>
									<input type="hidden" name="eduDegreeCd" value="">
								</button>
							</div>
							<div class="select_box">
								<ul class="clearfix">
						...
						<div class="form_element select">
							<div class="view_area">
								...
								<button type="button" class="text_box open" title="Open selection box" id="rl_langCd_native_focus">
									<span>Open</span>
									<input type="hidden" id="rl_langCd_native" value="" />
								</button>
							</div>
							<div class="select_box">
								<ul class="clearfix">
			...
			<div class="bbs_btn_wrap form_btnbox">
				<div class="bbs_center">
					...
					<button type="button" class="bbs_btn type01" id="btn_save">REGISTER</button>
				</div>
			</div>
