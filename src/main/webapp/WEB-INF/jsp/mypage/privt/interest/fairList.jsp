	...
	<main class="colgroup" id="colgroup">
		<article>
	    	<header class="sub_head">
	       	...
	       	<div id="contents" class="interestFairList">
				<div class="bbs_info clearfix"><!-- 서브페이지에 탭 메뉴가 있을 경우 클래스 tab_confirm 추가  -->
					<form id="frm" name="frm" action="${pageContext.request.contextPath}/cpes/private/interest/fairList.do" method="post">
				...
				<div class="bbs_btn_wrap clearfix">
					...
					<span class="bbs_right">
						<button type="button" onclick="fnInterestFair();" class="bbs_btn delete"><spring:message code="button.delete"/></button>
					</span>
				</div>
				<!-- //bbs_btn_wrap -->
