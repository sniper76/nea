				...
				success : function(json, statusText, xhr, $form) {
					if (json.result.successYn == "Y") {
						alertify.alert("<spring:message code="counsel.msg.update.ok"/>", function (e){
							fnGoMoveUrl('frmSearch', '${pageContext.request.contextPath}/cpes/all/mypage/counsel/list.do');
						});
	    	...
	    	<header class="sub_head">
	       	...
	       	<div id="contents" class="counselModify">
				...
				<div class="bbs_basic">
					...
					<form id="frm" name="frm" action="${pageContext.request.contextPath}/cpes/all/mypage/counsel/modifyProcessAjax.do" method="post">
