...
<%@ include file="/WEB-INF/jsp/common/inc.jsp" %>
    <script>
    	...
    	function fnGoCounselView(seq) {
    		$("#condSeq").val(seq);
    		$("#frm").attr('action', "${pageContext.request.contextPath}/cpes/all/mypage/counsel/view.do");
    		$("#frm").submit();
    	}
	    	...
	    	<header class="sub_head">
	       	...
	       	<div id="contents" class="counselList">
				<div class="bbs_info clearfix tab_confirm"><!-- 서브페이지에 탭 메뉴가 있을 경우 클래스 tab_confirm 추가  -->
					<form id="frm" name="frm" action="${pageContext.request.contextPath}/cpes/all/mypage/counsel/list.do" method="post">
