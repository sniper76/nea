	       	...
	       	<div id="contents" class="counselView">
				...
				<div class="bbs_btn_wrap clearfix">
					...
					<span class="bbs_right">
						...
						<a href="javascript:fnGoMoveUrl('frmSearch','${pageContext.request.contextPath}/cpes/private/mypage/counsel/modify.do');" class="bbs_btn modify"><spring:message code="button.modify"/></a>
						<a href="javascript:fnGoCounselDelete('${result.counselSeq}','MYPAGE_COUNSEL');" class="bbs_btn cancel"><spring:message code="button.delete"/></a>
						</c:if>
					</span>
				</div>
				<!-- //bbs_btn_wrap -->
