...
<%@ include file="/WEB-INF/jsp/common/inc.jsp" %>
    <script>
    	...
    	function fnGoCounselView(seq) {
    		$("#condSeq").val(seq);
    		$("#frm").attr('action', "${pageContext.request.contextPath}/cpes/private/mypage/counsel/view.do");
    		$("#frm").submit();
    	}
	...
	<main class="colgroup" id="colgroup">
		<article>
	    	<header class="sub_head">
				<div class="sub_title">
					<h2>
						<span><spring:message code="counsel.msg.title3"/></span>
					</h2>
				</div>
	      	</header>
	       	...
	       	<div id="contents" class="counselList">
				<div class="bbs_info clearfix tab_confirm"><!-- 서브페이지에 탭 메뉴가 있을 경우 클래스 tab_confirm 추가  -->
					<form id="frm" name="frm" action="${pageContext.request.contextPath}/cpes/private/mypage/counsel/list.do" method="post">
