...
<%@ include file="/WEB-INF/jsp/common/inc.jsp" %>
    <script>
    	$(document).ready(function() {
      	...
      	function fnInviteNo(seq,seq2,frmId) {

    		alertify.confirm("<spring:message code="mypage.private.fair.errors.msg"/>", function (e) {
    			if (e) {
    				$.ajax({
    					url: contextPath + "/cpes/compny/fair/inviteCancelProcessAjax.do",
    					type: 'post',
    					data: {
    						condSeq : seq,
    						condSeq2 : seq2
	...
	<main class="colgroup" id="colgroup">
		<article>
	    	<header class="sub_head">
	       	...
	       	<div id="contents" class="fairJoinList">
				<div class="bbs_info clearfix tab_confirm"><!-- 서브페이지에 탭 메뉴가 있을 경우 클래스 tab_confirm 추가  -->
					<form id="frm" name="frm" action="${pageContext.request.contextPath}/cpes/compny/fair/joinList.do" method="post">
