    	...
    	$(document).ready(function() {
      	...
      	function fnCancelBooth(seq,frmId) {
    		...
    		alertify.confirm("<spring:message code="mypage.private.fair.errors.msg"/>", function (e) {
    			if (e) {
    				$.ajax({
    					url: contextPath + "/cpes/compny/fair/boothCancelProcessAjax.do",
    					type: 'post',
    					data: {
    						condSeq : seq
    					},
	       	...
	       	<div id="contents" class="fairBoothList">
				<div class="bbs_info clearfix"><!-- 서브페이지에 탭 메뉴가 있을 경우 클래스 tab_confirm 추가  -->
					...
					<div class="bbs_right bbs_category">
						<form id="frm" name="frm" action="${pageContext.request.contextPath}/cpes/compny/fair/boothList.do" method="post">
				...
				<p class="bbs_write_bottom em_blue">※ The reserved booth cannot be canceled 10 days before the event start date.</p>
