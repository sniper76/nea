	...
	<main class="colgroup" id="colgroup">
		<article>
	    	<header class="sub_head">
				<div class="sub_title">
					<h2>
						<span><spring:message code="mypage.compny.interest.title"/></span>
					</h2>
				</div>
	      	</header>
	       	...
	       	<div id="contents" class="interestVacancyList">
				<div class="bbs_info clearfix tab_confirm"><!-- 서브페이지에 탭 메뉴가 있을 경우 클래스 tab_confirm 추가  -->
					<form id="frm" name="frm" action="${pageContext.request.contextPath}/cpes/compny/interest/vacancyList.do" method="post">
...
<%-- 							<span class="check_box">
								...
								<input type="checkbox" id="chk_${status.count}" name="chk" />
							</span> --%>
