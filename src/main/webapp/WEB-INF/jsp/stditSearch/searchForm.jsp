...
<div class="srch_area advanced"><!-- 상세 검색 있을 때 클래스 advanced 추가 -->
	<div class="box_wrap">
		<form id="simpleSearchForm" method="post" action="${pageContext.request.contextPath}/cpes/compny/stditSearch/stditSearchResult.do">
...
<div class="detail_area">
	<div class="box_wrap">
		<form id="detailSearchForm" method="post" action="${pageContext.request.contextPath}/cpes/compny/stditSearch/stditSearchResult.do">
			<input type="hidden" name="currentPageNo" value=""/>
