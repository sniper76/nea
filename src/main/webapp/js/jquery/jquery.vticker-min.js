...
(function(a){
	a.fn.vTicker=function(b){
		...
		moveDown=function(g,d,e){
			...
			return this.each(function(){var f=a(this);var e=0;f.css({width: "100%",position:"relative",overflow:"hidden"}).children("ul").css({position:"absolute",margin:0,padding:0 }).children("li").css({margin:0,padding:"20px 10px 20px 20px"}).children(".mess_box").css({display: "inline-block",width: "250px", marginLeft:"15px", lineHeight: "150%"}).children(".winner").css({marginBottom:"10px"});
			...
			function(){b.isPaused=false})}})}})(jQuery);