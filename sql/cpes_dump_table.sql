...
CREATE TABLE IF NOT EXISTS `CPES_BULLETIN` (
  ...
  `PHOTO_FILE_GRP_SEQ` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '사진_파일_그룹_시퀀스',
...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='CPES_게시판';
...
-- 내보낼 데이터가 선택되어 있지 않습니다.
-- 테이블 cpes_dev.CPES_FAIR_BOOTH_RESV_WAIT 구조 내보내기
DROP TABLE IF EXISTS `CPES_FAIR_BOOTH_RESV_WAIT`;
CREATE TABLE IF NOT EXISTS `CPES_FAIR_BOOTH_RESV_WAIT` (
  `FAIR_BOOTH_RESV_WAIT_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '행사_부스_예약_대기_시퀀스',
  `COMPNY_INSTT_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '기업_기관_시퀀스',
  ...
  `REG_DT` datetime DEFAULT NULL COMMENT '등록_날짜',
  `COMPNY_INSTT_DIV_CD` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '기업_기관_구분_코드'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='CPES_채용행사_부스_예약_대기';
...
CREATE TABLE IF NOT EXISTS `CPES_FAIR_PATCPTN_COMPNY` (
  ...
  `JC_AGREE_USER_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'JOB_CENTER_승인_사용자_시퀀스',
  `JC_AGREE_DT` datetime DEFAULT NULL COMMENT 'JOB_CENTER_승인_날짜',
  `COMPNY_RESP_YN` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '기업_응답_여부',
  `REQ_DT` datetime DEFAULT NULL COMMENT '신청_날짜',
  `INVITE_YN` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '초청_여부',
...
CREATE TABLE IF NOT EXISTS `CPES_FAIR_PATCPTN_INSTT` (
  ...
  `INSTT_RESP_YN` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '기관_응답_여부',
  `REQ_DT` datetime DEFAULT NULL COMMENT '신청_날짜',
  `INVITE_YN` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '초청_여부',
  `INVITE_DT` datetime DEFAULT NULL COMMENT '초청_날짜',
  `REG_USER_SEQ` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '등록_사용자_시퀀스',
  `REG_DT` datetime DEFAULT NULL COMMENT '등록_날짜',
  `DEL_YN` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N' COMMENT '삭제_여부',
...
CREATE TABLE IF NOT EXISTS `CPES_FAIR_PATCPTN_INSTT_TRNNG` (
  ...
  PRIMARY KEY (`FAIR_SEQ`,`EDU_TRNNG_SEQ`),
...
CREATE TABLE IF NOT EXISTS `CPES_FAIR_WORKSHOP_PATCPTN` (
  `FAIR_WORKSHOP_PATCPTN_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '행사_워크샵_참여_시퀀스',
  `FAIR_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '행사_시퀀스',
...
CREATE TABLE IF NOT EXISTS `CPES_SURVEY` (
  ...
  `MOD_USER_SEQ` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '수정_사용자_시퀀스',
  `MOD_DT` datetime NOT NULL COMMENT '수정_날짜',
  `SURVEY_BGN_DT` datetime DEFAULT NULL COMMENT '설문_시작_날짜',
  `SURVEY_END_DT` datetime DEFAULT NULL COMMENT '설문_종료_날짜',
...
-- 내보낼 데이터가 선택되어 있지 않습니다.
-- 테이블 cpes_dev.CPES_VIDEO_INTVW 구조 내보내기
DROP TABLE IF EXISTS `CPES_VIDEO_INTVW`;
CREATE TABLE IF NOT EXISTS `CPES_VIDEO_INTVW` (
  `VIDEO_INTVW_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '영상_면접_시퀀스',
  `COMPNY_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '기업_시퀀스',
  `VIDEO_INTVW_BGN_DT` datetime DEFAULT NULL COMMENT '영상_면접_시작_날짜',
  `JC_CD` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JOB_CENTER_코드(JC_CD)',
  `JC_USER_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JOB_CENTER_사용자_시퀀스',
  `VIDEO_INTVW_END_DT` datetime DEFAULT NULL COMMENT '영상_면접_종료_날짜',
  `REG_USER_SEQ` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '등록_사용자_시퀀스',
  `REG_DT` datetime NOT NULL COMMENT '등록_날짜',
  `MOD_USER_SEQ` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '수정_사용자_시퀀스',
  `MOD_DT` datetime NOT NULL COMMENT '수정_날짜',
  `JC_AGREE_STS_CD` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '면접승인여부',
  `JC_AGREE_DT` date DEFAULT NULL COMMENT '면접승인일시',
  `INTVW_MNGER` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '면접담당자',
  `VIDEO_INTVW_BGN_HOUR` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '영상_면접_시작_시간',
  `VIDEO_INTVW_BGN_MINUTE` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '영상_면접_시작_분',
  `VIDEO_INTVW_BGN_AMPM` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `VIDEO_INTVW_END_HOUR` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `VIDEO_INTVW_END_MINUTE` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `VIDEO_INTVW_END_AMPM` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `REQ_CONTENT` text COLLATE utf8mb4_unicode_ci COMMENT '신청_내용',
  `DEL_YN` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '삭제여부',
  PRIMARY KEY (`VIDEO_INTVW_SEQ`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='CPES_영상_면접';

-- 내보낼 데이터가 선택되어 있지 않습니다.
-- 테이블 cpes_dev.CPES_VIDEO_INTVW_USER 구조 내보내기
DROP TABLE IF EXISTS `CPES_VIDEO_INTVW_USER`;
CREATE TABLE IF NOT EXISTS `CPES_VIDEO_INTVW_USER` (
  `VIDEO_INTVW_USER_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '영상_면접_사용자_시퀀스',
  `VIDEO_INTVW_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '영상_면접_시퀀스',
  `USER_SEQ` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '사용자_시퀀스',
  `REG_DT` datetime NOT NULL COMMENT '등록_날짜',
  `MOD_DT` datetime NOT NULL COMMENT '수정_날짜',
  `REG_USER_SEQ` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '등록_사용자_시퀀스',
  `MOD_USER_SEQ` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '수정_사용자_시퀀스',
  PRIMARY KEY (`VIDEO_INTVW_USER_SEQ`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='CPES_영상_면접_사용자';
...
BEGIN
    ...
    IF IF(FILE_PATH, 0, 1) = 1
    THEN 
      SELECT T.SAVE_FILE_PATH INTO FILE_PATH
	  FROM CPES_ATTACH_FILES T
	  WHERE T.FILE_GRP_SEQ = FILE_SEQ;
	END IF;
...
DELIMITER //
CREATE DEFINER=`cpes`@`%` FUNCTION `FN_GET_INSTT_NM`(IN_INSTT_SEQ VARCHAR(36), IN_LANG_CD VARCHAR(3)) RETURNS varchar(100) CHARSET utf8mb4
BEGIN
  DECLARE RET_VAL VARCHAR(100);
...
BEGIN
  ...
  SET V_STR_DATE = CASE WHEN P_DIV = 'S' THEN CONCAT(V_STR_DATE, ' ', '12:00:00') ELSE CONCAT(V_STR_DATE, ' ', '23:59:59') END;
